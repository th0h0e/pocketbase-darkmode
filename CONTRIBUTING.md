...
Directory Structure
  ...
  │   ├── providers.js         # OAuth2 provider configs (27+
  providers)
  │   ├── mimes.js             # MIME type mappings
  │   ├── components/          # UI components
  │   │   ├── base/            # Reusable components (37 files)
  │   │   ├── collections/     # Collection management (22+ files)
  │   │   │   ├── schema/      # Field type editors (16 files)
  │   │   │   ├── providers/   # OAuth2 provider UIs
  │   │   │   └── docs/        # API documentation (45 files)
  │   │   ├── records/         # Record CRUD (19 files)
  │   │   │   └── fields/      # Field display components (16 files)
  │   │   ├── settings/        # App settings pages (18 files)
  │   │   ├── logs/            # Activity logs
  │   │   └── superusers/      # Admin auth pages
  │   ├── stores/              # Svelte stores (state management)
  │   ├── utils/               # Helpers (ApiClient.js,
  CommonHelper.js)
  │   ├── actions/             # Svelte actions (tooltip, scrollend)
  │   └── scss/                # Global styles (26 files)
  ├── vite.config.js           # Vite config (@ alias → ./src)
  └── package.json             # Dependencies & scripts
  ---
    Key Entry Points
    File: src/main.js
    Purpose: Bootstraps Svelte app
    ────────────────────────────────────────
    File: src/App.svelte
    Purpose: Root layout, sidebar, routing
    ────────────────────────────────────────
    File: src/routes.js
    Purpose: Route definitions with auth guards
    ────────────────────────────────────────
    File: src/stores/
    Purpose: Global state (collections, superuser, toasts, errors)
    ────────────────────────────────────────
    File: src/utils/ApiClient.js
    Purpose: PocketBase SDK wrapper
    ---
    Where to Start Contributing
    Goal: New reusable UI component
    Location: src/components/base/
    ────────────────────────────────────────
    Goal: New page/feature
    Location: Add route in routes.js, create in src/components/
    ────────────────────────────────────────
    Goal: Modify collection management
    Location: src/components/collections/
    ────────────────────────────────────────
    Goal: Change record display/editing
    Location: src/components/records/
    ────────────────────────────────────────
    Goal: Settings pages
    Location: src/components/settings/
    ────────────────────────────────────────
    Goal: Global state changes
    Location: src/stores/
    ────────────────────────────────────────
    Goal: Utility functions
    Location: src/utils/CommonHelper.js
    ────────────────────────────────────────
    Goal: Styling
    Location: src/scss/ or scoped <style> in components
    
    
    
Component: Backend API
 URL: http://localhost:8090
 Purpose: PocketBase API server
 ────────────────────────────────────────
 ...
 Purpose: Embedded Admin UI (from ui/dist/)
 The frontend at :3000 proxies API requests to the backend at :8090
  (configured in ui/.env.development).
